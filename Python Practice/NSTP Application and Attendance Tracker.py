...
def student_registration():
    ...
    while True:
        nstp_component = input("NSTP Component (LTS, NSTP, ROTC): ").upper()
        if nstp_component in ["LTS", "NSTP", "ROTC"]:
            break
        else:
            print("Invalid component. Please choose LTS, NSTP, or ROTC.")
...
def update_student_status():
    ...
    for student in students.display():
        if student['nstp_component'] == "ROTC" or "NSTP" or "LTS":
            missed_days = 0
