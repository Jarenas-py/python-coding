...
print(message.count("Hello")) #Finds the string "Hello". If none, it prints 0. 
#If there is, it prints the interger of how many that string is is in the value of the variable message.
